...
Config.Music = {
    default = 'https://www.youtube.com/watch?v=PXtZCqHQrY0&ab_channel=PayGotti',
    volume = .3,
}
...
Config.UI = {
    ['settings'] = true,
    ['spawn_selector'] = true,
    ['discord'] = 'https://discord.gg/uQ6T7Rnf', -- [STRING] Set your Discord URL to show that content or set it to false to disable discord icon.
...
Config.ServerLogo = 'https://files.fivemerr.com/images/c04bbaac-cf6a-4d02-9714-0643b5f4389b.png'
...
Config.CommandGroupAllowed = 'admin', 'superadmin', 'god'
